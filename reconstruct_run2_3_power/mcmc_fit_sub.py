# Copied the code mcmc_fit_fofmasscut.py on 07/06/2016.
...
# MCMC routine
def mcmc_routine(k_range, mu_range, Pk_wnow_obs, ivar_Pk_wnow, ofile_params, space_id):
    ...
    for rec_id in xrange(1, 2):
        ...
        for z_id in xrange(3):
            for space_id in xrange(2):
                ifile_Pk = './{}_Pk_2d_wnw_mean_{}_ksorted_mu/{}kave{}.wnw_mean_sub_a_{}.dat'.format(sim_run, rec_dirs[rec_id], rec_fprefix[rec_id], sim_space[space_id], sim_a[z_id])
                Pk_wnow_obs = np.loadtxt(ifile_Pk, dtype='f4', comments='#', usecols=(2,)) # be careful that there are k, \mu, P(k, \mu) columns.
                
                ifile_Cov_Pk = './{}_Cov_Pk_2d_wnw_mean_{}_ksorted_mu/{}kave{}.wnw_mean_sub_a_{}.dat'.format(sim_run, rec_dirs[rec_id], rec_fprefix[rec_id], sim_space[space_id], sim_a[z_id])
                ...
                mcmc_routine(k_p, mu_p, Pk_wnow_obs, ivar_Pk_wnow, ofile_params, space_id)
                print('\n')
